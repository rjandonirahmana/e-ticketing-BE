...
pub struct StoryOverlay {
    ...
    pub z_index: u32,
    // 🔴 NEW: gaya teks Instagram (classic, modern, strong, typewriter)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub text_style: Option<String>,
    // 🔴 NEW: alignment teks (left / center / right)
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct StoryItem {
    ...
    pub viewed: bool,
    // Deep link ke event — diisi saat story dibuat dari EventDetailPage
