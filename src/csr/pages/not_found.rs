        ...
        <div class="page nf-page">
            ...
            <div class="nf-content">
                ...
                <div class="nf-number-wrap">
                    <div class="nf-number" data-text="404">"404"</div>
                    <div class="nf-number nf-number-glitch" data-text="404" aria-hidden="true">"404"</div>
                </div>
                ...
                <div class="nf-actions">
                    ...
                    <A href="/explore" attr:class="nf-btn-secondary">
                        "EXPLORE EVENTS"
                    </A>
                </div>
            ...
            <style>
                ...
                .nf-orb-1 {
                    ...
                    background: rgba(200, 255, 94, 0.07);
                    top: -80px; right: -80px;
                    z-index: 0;
                }
                .nf-orb-2 {
                ...
                .nf-number {
                    ...
                    letter-spacing: -4px;
                    text-shadow:
                        0 0 40px rgba(200, 255, 94, 0.4),
                        0 0 80px rgba(200, 255, 94, 0.15);
                }
                .nf-number-glitch {
                    position: absolute;
                    top: 0; left: 0; right: 0;
                    color: rgba(200, 255, 94, 0.15);
                    animation: nf-glitch 3s infinite;
                ...
                .nf-status-tag {
                    ...
                    border: 1px solid rgba(200, 255, 94, 0.2);
                    border-radius: 100px;
                    padding: 4px 14px;
                    font-size: 11px;
                    font-weight: 600;
                ...
                .nf-status-dot {
                    ...
                    background: #c8ff5e;
                    border-radius: 50%;
                    animation: nf-blink 1.2s infinite;
                }
                @keyframes nf-blink {
                    0%, 100% { opacity: 1; }
                    50% { opacity: 0.2; }
                ...
                .nf-suggestion-link:hover {
                    color: #c8ff5e;
                    border-color: rgba(200, 255, 94, 0.2);
