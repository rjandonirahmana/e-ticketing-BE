...
use crate::csr::components::{BottomNav, EmptyState, EventCardShimmer};
use crate::csr::hooks::ThemeToggle;
use crate::csr::state::use_events_store;
...
fn SearchOverlay(
    ...
    store: crate::csr::state::events::EventsCtx,
) -> impl IntoView {
...
pub fn ExplorePage() -> impl IntoView {
    ...
    let ph_idx = RwSignal::new(0usize);
        ...
        set_interval_with_handle(
            move || {
                ...
                spawn_local(async move {
                    ...
                    let next = (ph_idx.get_untracked() + 1) % phs2.len();
                    ph_idx.set(next);
    ...
    Effect::new(move |_| {
        ...
        if let Some(win) = web_sys::window() {
            let _ = win.add_event_listener_with_callback(
                "keydown",
                handler.as_ref().unchecked_ref::<web_sys::js_sys::Function>(),
            );
        }
